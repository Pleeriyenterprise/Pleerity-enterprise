...
**Frontend (`.env`):**
```bash
REACT_APP_BACKEND_URL=https://workmaster-app.preview.emergentagent.com
```
...
### API Health Check
```bash
curl https://workmaster-app.preview.emergentagent.com/api/health
```
...
# Submit intake
curl -X POST https://workmaster-app.preview.emergentagent.com/api/intake/submit \
...
# Login
curl -X POST https://workmaster-app.preview.emergentagent.com/api/auth/login \
  -H "Content-Type: application/json" \
