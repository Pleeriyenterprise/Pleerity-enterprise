...
FRONTEND_URL = os.getenv("FRONTEND_URL", "https://leadsquared.preview.emergentagent.com")
BACKEND_URL = os.getenv("REACT_APP_BACKEND_URL", "https://leadsquared.preview.emergentagent.com")
