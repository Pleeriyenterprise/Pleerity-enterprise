...
FRONTEND_URL = os.getenv("FRONTEND_URL", "https://assistify-hub.preview.emergentagent.com")
BACKEND_URL = os.getenv("REACT_APP_BACKEND_URL", "https://assistify-hub.preview.emergentagent.com")
