...
def build_commercial_snapshot_from_intake_form(
    ...
    *,
    ...
    snap = {
        ...
        "first_checkout_total_minor": monthly_minor + onboarding_minor,
        "recurring_monthly_minor": monthly_minor,
        "currency": "GBP",
...
def commercial_snapshots_match(
    ...
    keys = [
        ...
        "first_checkout_total_minor",
        "recurring_monthly_minor",
        "pilot_program_type",
        "pilot_discount_percent",
        "pilot_discount_months",
        "pilot_discount_duration",
        "onboarding_fee_policy",
        "onboarding_fee_waived",
        "pilot_commercial_summary",
        "currency",
