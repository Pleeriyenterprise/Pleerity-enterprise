...
UNSUBSCRIBE_URL = os.environ.get("UNSUBSCRIBE_URL", "https://prompt-versioner-1.preview.emergentagent.com/unsubscribe")
...
**Quick links:**
- [View our services](https://prompt-versioner-1.preview.emergentagent.com/services)
- [Book a consultation](https://prompt-versioner-1.preview.emergentagent.com/contact)
- [Start your free trial](https://prompt-versioner-1.preview.emergentagent.com/intake)
...
[Complete your setup now](https://prompt-versioner-1.preview.emergentagent.com/intake)
...
📋 [Compare our plans](https://prompt-versioner-1.preview.emergentagent.com/pricing)
💬 [Chat with our team](https://prompt-versioner-1.preview.emergentagent.com/) (available 24/7)
📞 [Book a call](https://prompt-versioner-1.preview.emergentagent.com/contact)
...
- Chat with us anytime at [pleerity.com](https://prompt-versioner-1.preview.emergentagent.com)
- Call us at +44 7440 645017

[Continue your setup →](https://prompt-versioner-1.preview.emergentagent.com/intake?resume={draft_id})
...
[Complete your setup now →](https://prompt-versioner-1.preview.emergentagent.com/intake?resume={draft_id})
...
[Complete your setup →](https://prompt-versioner-1.preview.emergentagent.com/intake?resume={draft_id})
...
- [Browse our services](https://prompt-versioner-1.preview.emergentagent.com/services)
- [Check our Knowledge Base](https://prompt-versioner-1.preview.emergentagent.com/support/knowledge-base)
- [Start a chat](https://prompt-versioner-1.preview.emergentagent.com) (24/7 support)
...
class LeadSLAService:
    ...
    async def notify_sla_breach(lead: Dict[str, Any]):
        ...
        ADMIN_DASHBOARD_URL = os.environ.get(
            "ADMIN_DASHBOARD_URL",
            "https://prompt-versioner-1.preview.emergentagent.com/admin/leads"
        )
