        ...
        try:
            ...
            for client in clients:
                ...
                if properties_with_changes and status_alerts_enabled:
                    frontend_url = os.getenv("FRONTEND_URL", "https://workflow-admin-4.preview.emergentagent.com")
        ...
        try:
            ...
            for billing in billings:
                try:
                    ...
                    frontend_url = os.environ.get("FRONTEND_URL", "https://workflow-admin-4.preview.emergentagent.com")
