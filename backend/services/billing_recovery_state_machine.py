...
_ALLOWED_TRANSITIONS: Dict[str, FrozenSet[str]] = {
    STATE_MODE_UNVERIFIED: frozenset(
        {STATE_RECOVERY_REQUIRED, STATE_ESCALATED_TO_SUPPORT, STATE_RECOVERY_FAILED}
    ),
    ...
    STATE_CUSTOMER_PENDING: frozenset(
        {STATE_CUSTOMER_COMPLETED, STATE_RECOVERY_RESOLVED, STATE_RECOVERY_FAILED, STATE_ESCALATED_TO_SUPPORT}
    ),
