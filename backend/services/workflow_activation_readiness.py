...
# Phase 2A: composite backbone (authority → gap → gated recalc/regen only; no broad fanout).
FAMILY_REQUIREMENT_STATE_TRANSITION_CORE_BACKBONE = "REQUIREMENT_STATE_TRANSITION_CORE_BACKBONE"
