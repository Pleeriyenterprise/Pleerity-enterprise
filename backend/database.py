...
class Database:
    ...
    async def _seed_notification_templates(self):
        ...
        templates = [
            ...
            {"template_key": "CONTRACTOR_ASSIGNED", "channel": "EMAIL", "email_template_alias": "admin-manual", "sms_body": None, "requires_provisioned": False, "requires_active_subscription": False, "requires_entitlement_enabled": False, "plan_required_feature_key": None, "is_active": True, "updated_at": now},
        ]
        for t in templates:
