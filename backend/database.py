...
class Database:
    ...
    async def _seed_notification_templates(self):
        ...
        templates = [
            ...
            {"template_key": "CLIENT_QUOTE_REVIEW_REQUIRED", "channel": "EMAIL", "email_template_alias": "client-quote-review-required", "sms_body": None, "requires_provisioned": False, "requires_active_subscription": False, "requires_entitlement_enabled": False, "plan_required_feature_key": None, "email_category": "system_critical", "is_active": True, "updated_at": now},
            {"template_key": "CLIENT_PROOF_UPLOADED", "channel": "EMAIL", "email_template_alias": "client-proof-uploaded", "sms_body": None, "requires_provisioned": False, "requires_active_subscription": False, "requires_entitlement_enabled": False, "plan_required_feature_key": None, "email_category": "system_critical", "is_active": True, "updated_at": now},
            {"template_key": "CLIENT_INVOICE_REVIEW_REQUIRED", "channel": "EMAIL", "email_template_alias": "client-invoice-review-required", "sms_body": None, "requires_provisioned": False, "requires_active_subscription": False, "requires_entitlement_enabled": False, "plan_required_feature_key": None, "email_category": "system_critical", "is_active": True, "updated_at": now},
            {"template_key": "CONTRACTOR_JOB_ASSIGNMENT_QUOTE_REQUIRED", "channel": "EMAIL", "email_template_alias": "contractor-job-assignment-quote-required", "sms_body": None, "requires_provisioned": False, "requires_active_subscription": False, "requires_entitlement_enabled": False, "plan_required_feature_key": None, "email_category": "system_critical", "is_active": True, "updated_at": now},
            {"template_key": "CONTRACTOR_QUOTE_APPROVED", "channel": "EMAIL", "email_template_alias": "contractor-quote-approved", "sms_body": None, "requires_provisioned": False, "requires_active_subscription": False, "requires_entitlement_enabled": False, "plan_required_feature_key": None, "email_category": "system_critical", "is_active": True, "updated_at": now},
            {"template_key": "CONTRACTOR_VISIT_CONFIRMED", "channel": "EMAIL", "email_template_alias": "contractor-visit-confirmed", "sms_body": None, "requires_provisioned": False, "requires_active_subscription": False, "requires_entitlement_enabled": False, "plan_required_feature_key": None, "email_category": "system_critical", "is_active": True, "updated_at": now},
            {"template_key": "CONTRACTOR_PROOF_REQUIRED", "channel": "EMAIL", "email_template_alias": "contractor-proof-required", "sms_body": None, "requires_provisioned": False, "requires_active_subscription": False, "requires_entitlement_enabled": False, "plan_required_feature_key": None, "email_category": "system_critical", "is_active": True, "updated_at": now},
            {"template_key": "CONTRACTOR_INVOICE_READY", "channel": "EMAIL", "email_template_alias": "contractor-invoice-ready", "sms_body": None, "requires_provisioned": False, "requires_active_subscription": False, "requires_entitlement_enabled": False, "plan_required_feature_key": None, "email_category": "system_critical", "is_active": True, "updated_at": now},
