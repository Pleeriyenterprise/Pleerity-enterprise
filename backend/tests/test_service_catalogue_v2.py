...
class TestPublicServicesV2:
    ...
    def test_services_by_category_groups_correctly(self, client):
        """GET /api/public/v2/services/by-category groups services correctly."""
        response = client.get("/api/public/v2/services/by-category")
    ...
    def test_document_packs_returns_tier_order(self, client):
        """GET /api/public/v2/services/document-packs returns packs in tier order."""
        response = client.get("/api/public/v2/services/document-packs")
    ...
    def test_document_pack_plus_inherits_11_documents(self, client):
    ...
    def test_document_pack_pro_inherits_15_documents(self, client):
    ...
    def test_get_service_not_found(self, client):
        ...
        response = client.get("/api/public/v2/services/INVALID_SERVICE")
        
        assert response.status_code == 404
    
    def test_get_service_intake_fields(self, client):
        """GET /api/public/v2/services/{service_code}/intake returns CRM field dictionary intake fields."""
        response = client.get("/api/public/v2/services/DOC_PACK_ESSENTIAL/intake")
    ...
    def test_price_calculation_base(self, client):
        """GET /api/public/v2/services/{service_code}/price calculates base price correctly."""
        response = client.get("/api/public/v2/services/DOC_PACK_ESSENTIAL/price")
    ...
    def test_price_calculation_with_fast_track(self, client):
        """Price calculation with fast_track=true adds £20."""
        response = client.get(
            "/api/public/v2/services/DOC_PACK_ESSENTIAL/price?fast_track=true"
        )
    ...
    def test_price_calculation_with_printed_copy(self, client):
        """Price calculation with printed_copy=true adds £25 (only for document packs)."""
        response = client.get(
            "/api/public/v2/services/DOC_PACK_ESSENTIAL/price?printed_copy=true"
        )
    ...
    def test_price_calculation_with_both_addons(self, client):
        """Price calculation with both fast_track and printed_copy."""
        response = client.get(
            "/api/public/v2/services/DOC_PACK_ESSENTIAL/price?fast_track=true&printed_copy=true"
        )
    ...
    def test_printed_copy_not_available_for_non_document_packs(self, client):
        """Printed copy addon should not apply to non-document pack services."""
        response = client.get(
            "/api/public/v2/services/AI_WF_BLUEPRINT/price?printed_copy=true"
        )
    ...
    def test_cvp_plans_returns_3_tiers(self, client):
        """GET /api/public/v2/cvp/plans returns 3 CVP subscription tiers."""
        response = client.get("/api/public/v2/cvp/plans")
...
class TestAdminServicesV2:
    ...
    def test_admin_list_requires_auth(self, client):
        ...
        response = client.get("/api/admin/services/v2/")
        
        assert response.status_code == 401 or response.status_code == 403
    
    def test_admin_list_services(self, client, admin_headers):
    ...
    def test_admin_stats_returns_correct_counts(self, client, admin_headers):
        """GET /api/admin/services/v2/stats returns correct counts by category."""
        response = client.get(
            "/api/admin/services/v2/stats",
            headers=admin_headers
        )
    ...
    def test_admin_categories_returns_all_enums(self, client, admin_headers):
        ...
        response = client.get(
            "/api/admin/services/v2/categories",
            headers=admin_headers
        )
    ...
    def test_admin_get_single_service(self, client, admin_headers):
        """GET /api/admin/services/v2/{service_code} returns service details."""
        response = client.get(
            "/api/admin/services/v2/DOC_PACK_PRO",
            headers=admin_headers
        )
    ...
    def test_admin_get_service_documents_with_inheritance(self, client, admin_headers):
        """GET /api/admin/services/v2/{service_code}/documents includes inherited docs."""
        response = client.get(
            "/api/admin/services/v2/DOC_PACK_PRO/documents?include_inherited=true",
            headers=admin_headers
        )
    ...
    def test_admin_get_service_documents_without_inheritance(self, client, admin_headers):
        """GET /api/admin/services/v2/{service_code}/documents without inheritance."""
        response = client.get(
            "/api/admin/services/v2/DOC_PACK_PRO/documents?include_inherited=false",
            headers=admin_headers
        )
    ...
    def test_admin_calculate_price(self, client, admin_headers):
        """GET /api/admin/services/v2/{service_code}/price calculates price."""
        response = client.get(
            "/api/admin/services/v2/DOC_PACK_PLUS/price?fast_track=true",
            headers=admin_headers
        )
...
class TestServiceCodes:
    ...
    def test_service_exists_with_correct_properties(self, client, service_code, expected_category, expected_price):
        """Verify each service exists with correct category and price."""
        response = client.get(f"/api/public/v2/services/{service_code}")
