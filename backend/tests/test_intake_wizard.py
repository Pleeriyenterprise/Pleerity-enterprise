...
class TestIntakeServices:
    ...
    def test_get_services_returns_200(self, client):
        """Services endpoint returns 200 OK"""
        response = client.get("/api/intake/services")
        assert response.status_code == 200
    
    def test_get_services_returns_11_services(self, client):
    ...
    def test_get_services_has_4_categories(self, client):
    ...
    def test_ai_automation_services(self, client):
    ...
    def test_market_research_services(self, client):
    ...
    def test_compliance_services(self, client):
...
class TestIntakePacks:
    ...
    def test_get_packs_returns_200(self, client):
        """Packs endpoint returns 200 OK"""
        response = client.get("/api/intake/packs")
        assert response.status_code == 200
    
    def test_get_packs_returns_3_packs(self, client):
    ...
    def test_get_packs_returns_2_addons(self, client):
    ...
    def test_fast_track_addon(self, client):
    ...
    def test_printed_copy_addon(self, client):
...
class TestIntakeSchema:
    ...
    def test_get_schema_doc_pack_essential(self, client):
        """Schema endpoint returns schema for DOC_PACK_ESSENTIAL"""
        response = client.get("/api/intake/schema/DOC_PACK_ESSENTIAL")
        assert response.status_code == 200
        data = response.json()
    ...
    def test_get_schema_hmo_audit(self, client):
        """Schema endpoint returns schema for HMO_AUDIT"""
        response = client.get("/api/intake/schema/HMO_AUDIT")
        assert response.status_code == 200
        data = response.json()
        assert data["service_code"] == "HMO_AUDIT"
        assert "fields" in data
    
    def test_get_schema_ai_wf_blueprint(self, client):
        """Schema endpoint returns schema for AI_WF_BLUEPRINT"""
        response = client.get("/api/intake/schema/AI_WF_BLUEPRINT")
        assert response.status_code == 200
        data = response.json()
        assert data["service_code"] == "AI_WF_BLUEPRINT"
        assert "fields" in data
    
    def test_schema_has_client_identity_fields(self, client):
    ...
    def test_schema_invalid_service_code(self, client):
        """Schema endpoint returns 404 for invalid service code"""
        response = client.get("/api/intake/schema/INVALID_SERVICE")
...
class TestIntakeDraft:
    ...
    def test_create_draft_returns_200(self, client):
    ...
    def test_create_draft_returns_draft_id(self, client):
    ...
    def test_create_draft_returns_draft_ref(self, client):
    ...
    def test_create_draft_has_pricing_snapshot(self, client):
    ...
    def test_create_draft_status_is_draft(self, client):
    ...
    def test_create_draft_has_audit_log(self, client):
...
class TestClientIdentityUpdate:
    ...
    def test_update_client_identity_returns_200(self, client, draft_id):
        """Update client identity returns 200 OK"""
        response = client.put(
            f"/api/intake/draft/{draft_id}/client-identity",
            json={
                "full_name": "Test User",
    ...
    def test_update_client_identity_persists_data(self, client, draft_id):
    ...
    def test_update_client_identity_adds_audit_log(self, client, draft_id):
    ...
    def test_update_client_identity_invalid_draft_id(self, client):
        """Update client identity returns 404 for invalid draft ID"""
        response = client.put(
            "/api/intake/draft/invalid-draft-id/client-identity",
            json={
                "full_name": "Test User",
                "email": "test@example.com",
                "phone": "+44 7123456789",
...
class TestCalculatePrice:
    ...
    def test_calculate_price_base_only(self, client):
    ...
    def test_calculate_price_with_fast_track(self, client):
    ...
    def test_calculate_price_with_printed_copy(self, client):
    ...
    def test_calculate_price_with_both_addons(self, client):
