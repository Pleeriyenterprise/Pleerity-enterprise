...
class TestReportingAuth:
    ...
    def test_unauthenticated_access_rejected(self):
        ...
        response = requests.get(f"{BASE_URL}/api/admin/reports/types")
...
class TestReportTypes:
    ...
    def test_get_report_types_returns_7_types(self, auth_headers):
        """Test that 7 report types are returned"""
        response = requests.get(
            f"{BASE_URL}/api/admin/reports/types",
    ...
    def test_get_report_types_returns_4_formats(self, auth_headers):
    ...
    def test_get_report_types_returns_periods(self, auth_headers):
...
class TestReportPreview:
    ...
    def test_preview_leads_report(self, auth_headers):
        """Test preview of leads report"""
        response = requests.get(
            f"{BASE_URL}/api/admin/reports/preview/leads?period=30d&limit=20",
            headers=auth_headers
        )
        assert response.status_code == 200
        data = response.json()
    ...
    def test_preview_revenue_report(self, auth_headers):
        """Test preview of revenue report"""
        response = requests.get(
            f"{BASE_URL}/api/admin/reports/preview/revenue?period=30d&limit=20",
            headers=auth_headers
        )
        assert response.status_code == 200
        data = response.json()
    ...
    def test_preview_orders_report(self, auth_headers):
        """Test preview of orders report"""
        response = requests.get(
            f"{BASE_URL}/api/admin/reports/preview/orders?period=30d&limit=20",
            headers=auth_headers
        )
        assert response.status_code == 200
        data = response.json()
    ...
    def test_preview_clients_report(self, auth_headers):
        """Test preview of clients report"""
        response = requests.get(
            f"{BASE_URL}/api/admin/reports/preview/clients?period=30d&limit=20",
            headers=auth_headers
        )
        assert response.status_code == 200
        data = response.json()
    ...
    def test_preview_compliance_report(self, auth_headers):
        """Test preview of compliance report"""
        response = requests.get(
            f"{BASE_URL}/api/admin/reports/preview/compliance?period=30d&limit=20",
            headers=auth_headers
        )
        assert response.status_code == 200
        data = response.json()
    ...
    def test_preview_enablement_report(self, auth_headers):
        """Test preview of enablement report"""
        response = requests.get(
            f"{BASE_URL}/api/admin/reports/preview/enablement?period=30d&limit=20",
            headers=auth_headers
        )
        assert response.status_code == 200
        data = response.json()
    ...
    def test_preview_consent_report(self, auth_headers):
        """Test preview of consent report"""
        response = requests.get(
            f"{BASE_URL}/api/admin/reports/preview/consent?period=30d&limit=20",
            headers=auth_headers
        )
        assert response.status_code == 200
        data = response.json()
    ...
    def test_preview_invalid_report_type(self, auth_headers):
        """Test preview with invalid report type returns 400"""
        response = requests.get(
            f"{BASE_URL}/api/admin/reports/preview/invalid_type?period=30d",
            headers=auth_headers
        )
...
class TestReportGenerate:
    ...
    def test_generate_csv_report(self, auth_headers):
    ...
    def test_generate_xlsx_report(self, auth_headers):
    ...
    def test_generate_json_report(self, auth_headers):
...
class TestScheduledReports:
    ...
    def test_toggle_scheduled_report(self, auth_headers):
        ...
        response = requests.put(
            f"{BASE_URL}/api/admin/reports/schedules/{schedule_id}/toggle",
            headers=auth_headers
        )
        assert response.status_code == 200
        data = response.json()
    ...
    def test_run_scheduled_report_now(self, auth_headers):
        ...
        response = requests.post(
            f"{BASE_URL}/api/admin/reports/schedules/{schedule_id}/run",
            headers=auth_headers
        )
    ...
    def test_delete_scheduled_report(self, auth_headers):
        ...
        response = requests.delete(
            f"{BASE_URL}/api/admin/reports/schedules/{schedule_id}",
            headers=auth_headers
        )
        assert response.status_code == 200
        data = response.json()
    ...
    def test_delete_nonexistent_schedule(self, auth_headers):
        """Test deleting a non-existent schedule returns 404"""
        response = requests.delete(
            f"{BASE_URL}/api/admin/reports/schedules/SCHED-NONEXISTENT",
            headers=auth_headers
        )
...
class TestReportHistory:
    ...
    def test_get_report_history(self, auth_headers):
    ...
    def test_get_report_executions(self, auth_headers):
        """Test getting scheduled report execution history"""
        response = requests.get(
            f"{BASE_URL}/api/admin/reports/executions",
            headers=auth_headers
        )
        assert response.status_code == 200
        data = response.json()
