...
def test_audit_pack_zip_contains_manifest_and_checksums():
    from services import compliance_audit_evidence_pack_service as caps
    ...
    with (
        ...
        patch("services.compliance_audit_evidence_pack_service.create_audit_log", new_callable=AsyncMock) as audit,
    ):
        summary = asyncio.run(
