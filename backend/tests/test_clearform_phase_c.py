...
class TestClearFormAuth:
    ...
    def test_login_orgtest_user(self, client):
        """Test login for orgtest@clearform.com (org owner)"""
        response = client.post("/api/clearform/auth/login", json=TEST_USER_1)
    ...
    def test_login_doctest_user(self, client):
        """Test login for doctest@clearform.com (document owner)"""
        response = client.post("/api/clearform/auth/login", json=TEST_USER_2)
        assert response.status_code == 200, f"Login failed: {response.text}"
        data = response.json()
        assert "access_token" in data
        assert "user" in data
...
class TestOrganizationAPIs:
    ...
    @pytest.fixture
    def auth_token_orgtest(self, client):
    ...
    @pytest.fixture
    def auth_token_doctest(self, client):
    ...
    def test_get_user_organizations(self, client, auth_token_orgtest):
        """GET /api/clearform/organizations - Get user's organizations"""
        headers = {"Authorization": f"Bearer {auth_token_orgtest}"}
        response = client.get("/api/clearform/organizations", headers=headers)
    ...
    def test_get_organization_details(self, client, auth_token_orgtest):
        """GET /api/clearform/organizations/{org_id} - Get org details"""
        headers = {"Authorization": f"Bearer {auth_token_orgtest}"}
        response = client.get(
            f"/api/clearform/organizations/{EXISTING_ORG_ID}",
            headers=headers
        )
    ...
    def test_get_organization_members(self, client, auth_token_orgtest):
        """GET /api/clearform/organizations/{org_id}/members - Get org members"""
        headers = {"Authorization": f"Bearer {auth_token_orgtest}"}
        response = client.get(
            f"/api/clearform/organizations/{EXISTING_ORG_ID}/members", 
            headers=headers
        )
    ...
    def test_get_pending_invitations(self, client, auth_token_orgtest):
        """GET /api/clearform/organizations/{org_id}/invitations - Get pending invitations"""
        headers = {"Authorization": f"Bearer {auth_token_orgtest}"}
        response = client.get(
            f"/api/clearform/organizations/{EXISTING_ORG_ID}/invitations", 
            headers=headers
        )
    ...
    def test_send_invitation(self, client, auth_token_orgtest):
    ...
    def test_get_org_credits(self, client, auth_token_orgtest):
        """GET /api/clearform/organizations/{org_id}/credits - Get org credit balance"""
        headers = {"Authorization": f"Bearer {auth_token_orgtest}"}
        response = client.get(
            f"/api/clearform/organizations/{EXISTING_ORG_ID}/credits", 
            headers=headers
        )
    ...
    def test_create_organization_already_owner(self, client, auth_token_orgtest):
    ...
    def test_non_member_cannot_access_org(self, client, auth_token_doctest):
    ...
    def test_list_compliance_packs(self, client, auth_token_orgtest):
        """GET /api/clearform/organizations/compliance-packs/list - List compliance packs"""
        headers = {"Authorization": f"Bearer {auth_token_orgtest}"}
        response = client.get(
            "/api/clearform/organizations/compliance-packs/list", 
            headers=headers
        )
...
class TestAuditLogAPIs:
    ...
    def test_get_my_audit_logs(self, client, auth_token_orgtest):
        """GET /api/clearform/audit/me - Get user's audit logs"""
        headers = {"Authorization": f"Bearer {auth_token_orgtest}"}
        response = client.get("/api/clearform/audit/me", headers=headers)
    ...
    def test_get_my_activity(self, client, auth_token_orgtest):
        """GET /api/clearform/audit/me/activity - Get recent activity"""
        headers = {"Authorization": f"Bearer {auth_token_orgtest}"}
        response = client.get("/api/clearform/audit/me/activity", headers=headers)
    ...
    def test_get_my_audit_stats(self, client, auth_token_orgtest):
        """GET /api/clearform/audit/me/stats - Get audit statistics"""
        headers = {"Authorization": f"Bearer {auth_token_orgtest}"}
        response = client.get("/api/clearform/audit/me/stats", headers=headers)
    ...
    def test_get_org_audit_logs(self, client, auth_token_orgtest):
        """GET /api/clearform/audit/org/{org_id} - Get org audit logs (admin only)"""
        headers = {"Authorization": f"Bearer {auth_token_orgtest}"}
        response = client.get(
            f"/api/clearform/audit/org/{EXISTING_ORG_ID}", 
            headers=headers
        )
    ...
    def test_get_org_activity(self, client, auth_token_orgtest):
        """GET /api/clearform/audit/org/{org_id}/activity - Get org recent activity"""
        headers = {"Authorization": f"Bearer {auth_token_orgtest}"}
        response = client.get(
            f"/api/clearform/audit/org/{EXISTING_ORG_ID}/activity", 
            headers=headers
        )
    ...
    def test_get_org_audit_stats(self, client, auth_token_orgtest):
        """GET /api/clearform/audit/org/{org_id}/stats - Get org audit stats"""
        headers = {"Authorization": f"Bearer {auth_token_orgtest}"}
        response = client.get(
            f"/api/clearform/audit/org/{EXISTING_ORG_ID}/stats", 
            headers=headers
        )
    ...
    def test_get_document_audit_trail(self, client, auth_token_doctest):
        """GET /api/clearform/audit/document/{document_id} - Get document audit trail"""
        headers = {"Authorization": f"Bearer {auth_token_doctest}"}
        response = client.get(
            f"/api/clearform/audit/document/{EXISTING_DOC_ID}", 
            headers=headers
        )
    ...
    def test_list_audit_actions(self, client, auth_token_orgtest):
        """GET /api/clearform/audit/actions - List all audit action types"""
        headers = {"Authorization": f"Bearer {auth_token_orgtest}"}
        response = client.get("/api/clearform/audit/actions", headers=headers)
    ...
    def test_list_audit_severities(self, client, auth_token_orgtest):
        """GET /api/clearform/audit/severities - List audit severity levels"""
        headers = {"Authorization": f"Bearer {auth_token_orgtest}"}
        response = client.get("/api/clearform/audit/severities", headers=headers)
    ...
    def test_non_admin_cannot_access_org_audit(self, client, auth_token_doctest):
...
class TestDocumentGeneration:
    ...
    def test_get_existing_document(self, client, auth_token_doctest):
        """GET /api/clearform/documents/{document_id} - Get existing document"""
        headers = {"Authorization": f"Bearer {auth_token_doctest}"}
        response = client.get(
            f"/api/clearform/documents/{EXISTING_DOC_ID}", 
            headers=headers
        )
    ...
    def test_get_document_types(self, client, auth_token_doctest):
        """GET /api/clearform/documents/types - Get available document types"""
        headers = {"Authorization": f"Bearer {auth_token_doctest}"}
        response = client.get("/api/clearform/documents/types", headers=headers)
    ...
    def test_get_user_vault(self, client, auth_token_doctest):
        """GET /api/clearform/documents/vault - Get user's document vault"""
        headers = {"Authorization": f"Bearer {auth_token_doctest}"}
        response = client.get("/api/clearform/documents/vault", headers=headers)
...
class TestCreditSystem:
    ...
    def test_get_credit_wallet(self, client, auth_token_doctest):
        """GET /api/clearform/credits/wallet - Get credit wallet"""
        headers = {"Authorization": f"Bearer {auth_token_doctest}"}
        response = client.get("/api/clearform/credits/wallet", headers=headers)
    ...
    def test_get_credit_packages(self, client, auth_token_doctest):
        """GET /api/clearform/credits/packages - Get available credit packages"""
        headers = {"Authorization": f"Bearer {auth_token_doctest}"}
        response = client.get("/api/clearform/credits/packages", headers=headers)
