...
async def seed_database():
    ...
    print("\n📝 Quick Start Guide:")
    print("   1. Admin Login: https://paperwork-assist-1.preview.emergentagent.com/admin/signin")
    print("   2. Client Signup: https://paperwork-assist-1.preview.emergentagent.com/intake/start")
    print("\n🔐 Admin Credentials:")
    print("   Email: admin@pleerity.com")
    print("   Password: Admin123!")
