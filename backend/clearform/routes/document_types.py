...
# ============================================================================
# System Templates & Rule Packs (Phase D) - MUST come before /{template_id}
# ============================================================================
...
@templates_router.get("/system/{system_template_id}")
async def get_system_template_details(
    ...
    details = await template_service.get_template_details(system_template_id)
    if not details:
...
# ============================================================================
# User Templates (with /{template_id} - MUST come AFTER /system routes)
# ============================================================================
