...
**Status:** G0 **`VERIFIED_OPERATIONALLY`**. G1 **EXECUTED** — `ATTENTION_PRIORITY_DRIFT` (3 precedence violations; mutation/snooze/CTA/G9/G10 pass). Run `20260524T152332Z`; bundle `ops_runtime_g1_today_6fd5ac4c_d35a58ae`. **G2 blocked.** Watchlist: deploy SHA; Today vs CC urgent count delta.
...
| G1 Today | `ops_control_g1_today_page` | EXECUTED | `ATTENTION_PRIORITY_DRIFT` — run `20260524T152332Z`; bundle `ops_runtime_g1_today_6fd5ac4c_d35a58ae` (3 precedence violations; mutation/convergence pass) |
