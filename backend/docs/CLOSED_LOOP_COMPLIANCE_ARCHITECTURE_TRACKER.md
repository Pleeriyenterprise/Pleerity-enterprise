...
| 2026-05-24 | **PRELAUNCH-OPS-RUNTIME-VERIFY-02 G1 Today:** first surface-family runtime — boot/mutation/snooze/CTA/G9/G10 pass; **ATTENTION_PRIORITY_DRIFT** (3 list-order violations: risk/issue outranked by WO/requirement/approval in urgent section); bundle `ops_runtime_g1_today_6fd5ac4c_d35a58ae` — **G2 blocked**. |
