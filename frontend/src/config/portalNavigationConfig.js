...
function filterLinkItem(item, { navHasFeature, showReports, showBilling }) {
 ...
 */
export function buildPortalNavigationModel({ navHasFeature, showReports, showBilling, userRole }) {
  const filterCtx = { navHasFeature, showReports, showBilling, userRole };
