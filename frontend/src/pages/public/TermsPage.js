        ...
        <div className="max-w-4xl mx-auto px-4 sm:px-6 lg:px-8">
          ...
          <div className="prose prose-lg max-w-none text-gray-700 space-y-8">
            ...
            <div>
              ...
              <h3 className="text-lg font-semibold text-midnight-blue mt-4 mb-2">Contractor and job coordination</h3>
              <p className="mb-3">
                Where the platform is used to coordinate jobs and contractor engagements, Pleerity facilitates 
